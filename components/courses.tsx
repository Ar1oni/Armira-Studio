  ...
  return (
    <section id="courses" className="py-20 bg-warm-brown/5">
      <div className="container mx-auto px-4">
        ...
        {/* ❗ Only 2 centered courses */}
        <div className="flex justify-center gap-8 flex-wrap">
          {courses.map((course, index) => (
            <div
              key={index}
              className="w-full sm:w-80 group overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 bg-cream border border-warm-brown/10"
            >
              {/* Image */}
              <div className="relative h-48 overflow-hidden">
                <img
